...
// Здесь у нас абсолютно идентичный пример к предыдущемо там где прототипы, тем самым мы понимаем что классы под капотом работают на прототипах !! и теперь у нас более чистый код
