...
//process.nextTick - это самый быстрый отложенны вызов(которого нет в браузере)
//в eventloop nextTick попадает раньше даже чем setTimeout по-этому будет вызван первый
process.nextTick(() => {
...
//это синхронные коллбеки, по-этому они исполнятся первыми
(callback => callback())(() => {
